...
useEffect(() => { if (!isMounted || !baseImageUrl) { console.log("Not mounted or no baseImageUrl:", { isMounted, baseImageUrl }); return; }
...
<div className="bg-white bg-opacity-90 p-8 rounded-lg shadow-lg max-w-md w-full relative z-10">
    <h1 className="text-3xl font-bold text-[#ff8098] mb-4 text-center">Canna Get A GM</h1>
    ...
    <button onClick={handleDownload} className="w-full mt-4 bg-[#ff8098] text-white font-semibold py-2 px-4 rounded hover:bg-[#ff6680] transition-all">Download Image</button>
  </div>
</div>
